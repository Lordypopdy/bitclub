...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="password.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Security</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Change password</h6><hr>
                            <?php if(isset($_GET['bootstrap'])){ ?><div class="alert alert-danger text-center bg-transparent" style="border: none; margin-bottom: -24px;"><?php echo $_GET['bootstrap']; ?></div><?php }elseif(isset($_GET['info'])){ ?> <div class="alert alert-info text-center"><?php echo $_GET['info']; ?></div> <?php } ?>
                           <form action="password-confg.php" method="post" class="form my-2">
                           <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon3">Old password</span>
                                <input type="password" name="old" class="form-control p-3" id="basic-url" aria-describedby="basic-addon3" placeholder="******" required>
                            </div>
                            <div class="input-group mb-3">
                                <input type="password" class="form-control p-3" name="new" aria-label="Default select example" placeholder="*******"
                                    aria-label="Recipient's username" aria-describedby="basic-addon2" required>
                                <span class="input-group-text" id="basic-addon2">New Password</span>
                            </div>
                            <div class="input-group mb-3">
                                <input type="password" class="form-control p-3" name="comfirm" aria-label="Default select example" placeholder="*******"
                                    aria-label="Recipient's username" aria-describedby="basic-addon2" required>
                                <span class="input-group-text" id="basic-addon2">Comfirm Password</span>
                            </div>
                            <button type="submit" name="password" class="btn btn-warning m-2">submit<i class="fa fa-inbox ms-2"></i></button>
                           </form>
                        </div>
                    </div>
                    <div class="col-sm-12 col-xl-6">
                             <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Two-Factor Security (Optional)</h6><hr>
                            <form action="password-confg.php" method="post" class="form">
                           <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon3">Old password</span>
                                <input type="password" name="old" class="form-control p-3" id="basic-url" aria-describedby="basic-addon3" placeholder="******" required>
                            </div>
                            <div class="input-group mb-3">
                                <input type="password" name="new" class="form-control p-3"name="acc_number" aria-label="Default select example" placeholder="*******"
                                     aria-describedby="basic-addon2" required>
                                <span class="input-group-text" id="basic-addon2">New Password</span>
                            </div>
                            <div class="input-group mb-3">
                                <input type="password" class="form-control p-3"name="acc_number" aria-label="Default select example" placeholder="*******"
                                    name="comfirm" aria-describedby="basic-addon2" required>
                                <span class="input-group-text" id="basic-addon2">Comfirm Password</span>
                            </div>
                            <button type="submit" name="submit" class="btn btn-warning m-2">submit<i class="fa fa-inbox ms-2"></i></button>
                           </form>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modal_wallet_pass_code End-->
        ...
        <div class="row align-items-center fixed-bottom mb-0 p-4 bg-secondry">
                    <div class="col bg-secondary p-1 rounded mobile mobile" style="margin-bottom: -20px;">
