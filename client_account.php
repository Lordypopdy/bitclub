									...
									<div class="card-body">
										<table class="table table-bordered">
											...
											<tbody class="text-center">
												<?php
												$select_1 = "SELECT * FROM signup ORDER BY id ASC"; 
												$select_2 = "SELECT * FROM user_details";
												$select_3 = "SELECT * FROM user_balance ";
												$query_1 = mysqli_query($conn, $select_1);
												$query_2 = mysqli_query($conn, $select_2);
												$query_3 = mysqli_query($conn, $select_3);
												...
												<tr>
													...
													<td><button class="btn btn-info p-1">Active</button></td>
													<td><?php echo $row_3['acc_balance'] ?></td>
													<td><?php echo $row_1['reg_date'] ?></td>
													<td><?php echo $row_2['reg_date'] ?></td>
												</tr>
												<?php } } } }  ?>
											</tbody>
												</table>
