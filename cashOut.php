    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
                        ...
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
								...
								$row_3 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM referral_earnings WHERE email='{$email}'"));
									?>
                                <button class="btn btn-success rounded-pill mb-0"><?php echo $row_3['referrals_code'] ?></button>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
            ...
            <?php if(isset($_GET['success'])){ ?>
                ...
                icon: 'success',
                timer: 5000,
                html:'<p style="color: #6C7293;"><?php echo $_GET['success'] ?></p>',
                background:'#191C24',
                color: '#ffc107',
                showCloseButton: false
                })
                </script> 
               <?php } elseif(isset($_GET['danger'])){ ?> <script> Swal.fire({ icon: 'error', title: 'Sorry...', text: '<?php echo $_GET['danger']; ?>', }) </script> <?php }
            elseif(isset($_GET['low_balance'])){ ?>
         <script> Swal.fire({ icon: 'question', iconHtml: '؟', html:'<p style="color: #6C7293;"><?php echo $_GET['low_balance'] ?></p>', background:'#191C24', color: '#ffc107', confirmButtonText: '<a href="dashboard.php?to_grind=#to_grind"  style= "color: #ffc107;">Grind..</a>', ancelButtonText: '<span class="text-danger">Cancel</span>', showCancelButton: true, showCloseButton: false }) </script>
             <?php } ?>
                   <?php if(isset($_GET['access'])){ ?>
                    ...
                    <?php } elseif (isset($_GET['danger'])) { ?>
                        ...
                        icon: 'question',
                        iconHtml: '؟',
                        html:'<p style="color: #6C7293;"><?php echo $_GET['danger'] ?></p>',
                        background:'#191C24',
                        color: '#ffc107',
                        confirmButtonText: '<a href="profilekey.php?#verification"  style= "color: #ffc107;">Verify account</a>',
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Start Withdrawal</h6>
                           <form action="cashOut_config.php" method="post" class="form">
                           ...
                           <select class="form-select mb-3" name="type" aria-label="Default select example" required>
                                ...
                                <option value="Referral earnings.">Referral earnings.</option>
                            </select>
                            </div>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control "name="acc_number" aria-label="Default select example" placeholder="Recipient's Account number"
                            ...
                            <button type="submit" name="submit" class="btn btn-warning m-2">Withdraw<i class="fa fa-inbox ms-2"></i></button>
                           </form>
                        </div>
                    </div>
                    <div class="col-sm-12 col-xl-6">
                            ...
                            <div class="owl-carousel testimonial-carousel">
                                ...
                                <div class="testimonial-item text-center">
                                <img class="img mx-auto" src="https://www.decolore.net/wp-content/uploads/2018/06/payment-method-credit-card-icons-for-e-commerce-cover.png">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid pt-4 px-4" style="margin-bottom: 25%;">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Withdrawal logs.</h6>
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                            <?php  $select_2 = "SELECT * FROM withdrawal_logs WHERE email='{$email}'"; $query = mysqli_query($conn, $select_2); if(mysqli_num_rows($query)){ while($row_1 = mysqli_fetch_assoc($query)){ ?>
                            <tr>
                                ...
                                <?php }else{ ?>
                                <td><button class="btn text-white btn-info  p-1"><?php echo $row_1['status'] ?></button></td>
                                <?php	} ?>
