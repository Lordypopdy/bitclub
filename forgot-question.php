...
<head>
    <meta charset="utf-8">
    <title>Bitclub | Forgot-question</title>
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <?php if(isset($_GET['danger'])){ ?><div class="alert alert-danger text-center" style="border: none; margin-bottom: -1px;"><?php echo $_GET['danger']; ?></div><?php }elseif(isset($_GET['info'])){ ?> <div class="alert alert-info text-center" style="font-size: 12px;"><?php echo $_GET['info']; ?></div> <?php } ?>
                      <form action="logquery.php" method="post"  class="form mt-2">
                      <small class="page-header text-light" style="font-size: 12px;">This question will be used to recover your account.</small>
                      <div class="form-floating mb-3">
                      <select class="form-select mb-3" name="question" aria-label="Default select example" required>
                      <option selected>Select question</option>
                        ...
                        <div class="form-floating mb-4">
                            <input type="text" name="answer" class="form-control" id="floatingPassword" placeholder="Password" required>
                            <label for="floatingPassword">Type in answer..</label>
                        </div>
                        ...
                        <button type="submit" name="forgot-question" style="background: #ffc107; border: none;" class="btn btn-primary py-3 w-100 mb-4">Sign In</button>
