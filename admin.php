        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="clients_plans.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Client plans</a>
                    <a href="client_account.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Client account</a>
                    <a href="withdraw.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Withdrawal</a>
...
<?php } ?>
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                               ...
                               <?php if(mysqli_num_rows(mysqli_query($conn, "SELECT * FROM status_2 WHERE id=1"))){ $row_2 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM status_2 WHERE id=1")); ?>
                               <a href="#"class="btn btn-warning rounded-pill mb-0 " style="margin-left: 18px;"><?php echo $row_2['pending'] ?></a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                                ...
                                <?php if(mysqli_num_rows(mysqli_query($conn, "SELECT * FROM active_plan WHERE id=1"))){ $row_2 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM active_plan WHERE id=1")); ?>
                                <a href="#"class="btn btn-warning rounded-pill mb-0 " style="margin-left: 18px;"><?php echo $row_2['active_plan'] ?></a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                        <i class="fa fa-chart-pie fa-3x" style="color: #ffc107;"></i>
                            <div class="ms-3">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Recent investors.</h6>
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                            <?php  $select_2 = "SELECT * FROM plans_logs WHERE status='Active'"; $query = mysqli_query($conn, $select_2); if(mysqli_num_rows($query)){ while($row_1 = mysqli_fetch_assoc($query)){ ?>
                                <tr>
                                ...
                                <td><button class="btn bg-dark text-warning rounded-pill m-2"><?php echo $row_1['email'] ?></button></td>
                            </tr>
                            <?php } } ?>
                            </tbody>
                        </table>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <?php  if(mysqli_num_rows(mysqli_query($conn, "SELECT * FROM referral_earnings WHERE email='{$email}'"))){ $row_2 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM referral_earnings WHERE email='{$email}'")); $ref_code = $row_2['referrals_code']; if(mysqli_num_rows(mysqli_query($conn, "SELECT * FROM referrals WHERE parent_code='{$ref_code}'"))){ $lp = mysqli_query($conn, "SELECT * FROM referrals WHERE parent_code='{$ref_code}'"); while($row_1 = mysqli_fetch_assoc($lp)){  ?>
                                        <tr>
                                            <th scope="row"><?php echo $row_1['id'] ?></th>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                            ...
                            <select class="form-select mb-2" name="plan_type" aria-label="Default select example" required>
                                ...
                                <button type="submit" class="btn ms-2" name="grinding" style="background: #ffc107;">Grind</button>
                            </div>
                            <div class="d-flex align-items-center border-bottom py-2">
                                <input class="form-check-input m-0" type="checkbox" required>
                                <div class="w-100 ms-3">
                                    <div class="d-flex w-100 align-items-center justify-content-between">
                                        <span>Short task-1 goes here...</span>
                            ...
                            <div class="d-flex align-items-center border-bottom py-2">
                                ...
                                <div class="w-100 ms-3">
                                    <div class="d-flex w-100 align-items-center justify-content-between">
                                        <span>Short tas-2 goes here...</span>
                                        <button type="button" class="btn btn-sm"><i class="fa fa-times"></i></button>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex align-items-center border-bottom py-2">
                                ...
                                <div class="w-100 ms-3">
                                    <div class="d-flex w-100 align-items-center justify-content-between">
                                        <span>Short task-3 goes here...</span>
                                        <button type="button" class="btn btn-sm"><i class="fa fa-times"></i></button>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex align-items-center pt-2">
                                ...
                                <div class="w-100 ms-3">
                                    <div class="d-flex w-100 align-items-center justify-content-between">
                                        <span>Short task-4 goes here...</span>
                                        <button type="button" class="btn btn-sm"><i class="fa fa-times"></i></button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a style="color: #ffc107;" href="#">Bitclub.</a>, All Right Reserved. 
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                            Designed By <a style="color: #ffc107;" href="https://htmlcodex.com">James Popdy Dev</a>
                            <br>Distributed By: <a style="color: #ffc107;" href="https://themewagon.com" target="_blank">Bitclub.</a>
                        </div>
                    </div>
                </div>
            </div>
