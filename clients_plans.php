...
<?php } ?>
		<div class="main-header">
					...
					<ul class="nav">
						...
						<li class="nav-item">
							<a href="admin-plans.php">
								...
								<p>Plans</p>
								<?php if(mysqli_num_rows(mysqli_query($conn, "SELECT * FROM plans ORDER BY id DESC"))){ 
								$row_4 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM plans ORDER BY id DESC")) ?>
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">Activated Plans</h4>
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-body table-responsive">
										<table class="table table-bordered">
											...
											<tbody class="text-center">
												<?php
												$select_1 = "SELECT * FROM plans_logs WHERE status='Active'"; 
												...
												<tr>
													...
													<td><a class="bg-info p-1 text-white" href="#"><?php echo $row_1['status'] ?></a></td>
													<td><?php echo $row_1['amount'] ?></td>
													<td><?php echo $row_1['duration'] ?></td>
